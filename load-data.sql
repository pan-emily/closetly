...
LOAD DATA LOCAL INFILE 'final-project/clothes.csv' INTO TABLE clothes
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

-- Load all user data into the user table.
LOAD DATA LOCAL INFILE 'final-project/user.csv' INTO TABLE user
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;
...
LOAD DATA LOCAL INFILE 'final-project/personal_closet.csv' INTO TABLE personal_closet
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' 
IGNORE 1 ROWS
...
-- store_closet table.
LOAD DATA LOCAL INFILE 'final-project/store_closet.csv' INTO TABLE store_closet
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;
...
LOAD DATA LOCAL INFILE 'final-project/collab_closet.csv' INTO TABLE collab_closet
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS
...
LOAD DATA LOCAL INFILE 'final-project/styled_outfits.csv' INTO TABLE styled_outfits
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;
